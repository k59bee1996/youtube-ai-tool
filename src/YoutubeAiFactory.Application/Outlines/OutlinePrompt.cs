    ...
    public static JsonNode Schema() => JsonNode.Parse("""
    {
      ...
      "properties":{
        ...
        "sections":{"type":"array","items":{"type":"object","additionalProperties":false,"properties":{
          ...
          "purpose":{"type":"string","enum":["Hook","Setup","Context","Explanation","Escalation","Example","Counterpoint","Conflict","Payoff","Conclusion"]},
