...
{
    public int TargetIdeaCount { get; init; } = 15;
    public int MinIdeaCount { get; init; } = 15;
    public int IdeasPerRequest { get; init; } = 15;
    ...
    public int MaxReplacementAttempts { get; init; }
