...
{
    public const string Key = "idea-generation"; public const int Version = 3;
    public static AiModelProfile ModelProfile => AiWorkflowProfiles.IdeaGeneration;
